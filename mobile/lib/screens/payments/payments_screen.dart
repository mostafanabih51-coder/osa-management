        ...
        return StatefulBuilder(
          builder: (dialogContext, setDialogState) {
            ...
            if (subscriptionId != null &&
                !subs.any((x) => x['id'] == subscriptionId)) {
              subscriptionId = null;
            }
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<int?>(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'الاشتراك عند الحاجة',
                      ),
                      items: [
                        const DropdownMenuItem<int?>(
                          value: null,
                          child: Text('بدون اشتراك'),
                        ),
                        ...subs.map(
                          (x) => DropdownMenuItem<int?>(
                            value: x['id'] as int,
                            child: Text('${x['subject']} • ${x['amount']}'),
                          ),
                        ),
                      ],
                      onChanged: (v) =>
                          setDialogState(() => subscriptionId = v),
                    ),
                    TextFormField(
                      controller: amount,
